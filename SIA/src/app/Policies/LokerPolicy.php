...
class LokerPolicy
{
    ...
    {
        return $user->can('view_any_loker');
    }
    ...
    {
        return $user->can('delete_any_loker');
    }
     ...
     */
    public function replicate(User $user, Loker $loker): bool
    {
